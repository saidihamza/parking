	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">إدارة المركبات في الخدمة</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">إدارة المركبات في الخدمة</div>
                        ...
                        <div class="col-md-12">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
									...
									<input type="text" class="form-control" value="<?php if($row['Status']==""){ echo "في الخدمة"; } if($row['Status']=="Out"){echo "Vehicle out";} ;?>" id="sdesc" name="sdesc" readonly>
								</div>
                                ...
                                <div class="form-group">
									...
									<select name="status" class="form-control" required="true" >
                                        <option value="في عُطْل">معطلة</option>
                                    </select>
								</div>
                        ...
                        <?php } ?>
									...
									<button type="submit" class="btn btn-success" name="submit-in">تقديم للصيانة</button>
