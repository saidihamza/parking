    ...
    <div class="container">
        ...
        <div class="form-section">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    <a href="forgot-password.php" style="color: #333;">هل نسيت كلمة السر؟</a>
                </div>
                <button id="btn-success" class="btn btn-success btn-block" type="submit" name="login"> الدخول</button>
                <a href="inscription.php" class="btn btn-primary btn-block mt-3">التسجيل</a>
                <a href="http://localhost/khawla-hlel" class="btn btn-secondary btn-block mt-3">العودة إلى الموقع</a>
            </form>
        </div>
    </div>
