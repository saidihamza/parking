...
<head>
    ...
    <title>نظام المركبات بالمستشفى العسكري</title>
                ...
                <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                    <div class="panel panel-teal panel-widget border-right">
                        <div class="row no-padding"><em class="fa fa-xl fa-car color-blue"></em>
                            ...
                            <div class="text-muted">  العدد الكلي للمركبات</div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                    <div class="panel panel-blue panel-widget border-right">
                        <div class="row no-padding"><em class="fa fa-xl fa-toggle-on color-orange"></em>
                            ...
                            <div class="text-muted"> المركبات في الخدمة</div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                    <div class="panel panel-orange panel-widget border-right">
                        <div class="row no-padding"><em class="fa fa-xl fa-toggle-off color-teal"></em>
                            ...
                            <div class="text-muted"> المركبات في حالة عطل</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                    <div class="panel panel-red panel-widget border-right">
                        <div class="row no-padding"><em class="fa fa-xl fa-motorcycle color-red"></em>
                            <div class="large"><?php include 'counters/twowheeler-count.php'?></div>
                            <div class="text-muted">دراجة نارية</div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                    <div class="panel panel-yellow panel-widget border-right">
                        <div class="row no-padding"><em class="fa fa-xl fa-car color-yellow"></em>
                            <div class="large"><?php include 'counters/fourwheeler-count.php'?></div>
                            <div class="text-muted">سيارة</div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                    <div class="panel panel-green panel-widget border-right">
                        <div class="row no-padding"><em class="fa fa-xl fa-truck color-green"></em>
                            <div class="large"><?php include 'counters/threewheeler-count.php'?></div>
                            <div class="text-muted">شاحنة</div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        window.onload = function () {
            ...
            var myChart2 = new Chart(ctx2, {
                type: 'pie',
                data: {
                    labels: ["نقل بضائع","نقل أفراد", "اسعاف"],
                    datasets: [{
